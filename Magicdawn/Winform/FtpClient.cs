 ...
 * 非静态类 new实例
 * 
 * 注意点.乱码的时候设置UseEncode属性
 * CheckFileExist()要先设置RemotePath
 * 
 * Upload也先设置remotepath
 * 
...
namespace Magicdawn
{
    ...
    public class FtpClient
    {
        ...
        #region 编码格式
        public System.Text.Encoding UseEncode = System.Text.Encoding.Default;
        #endregion
