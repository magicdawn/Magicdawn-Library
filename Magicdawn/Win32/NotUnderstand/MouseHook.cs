    ...
    public class MouseHook
    {
        ...
        public void Install_Hook()
        {
            if (this.MouseHookHandle == 0)
            {
                ...
                this.MouseHookHandle = Api.SetWindowsHookEx(
                ...
                if (this.MouseHookHandle == 0)
                {
                    ...
                    throw new Win32Exception("MouseHook.EnsureGlobalMouseEvents()->" + Api.GetLastErrorString(errorCode));
                }
            }
        }
        ...
        public void Uninstall_Hook()
        {
                ...
                this.EventMouseMoveExt == null)
            {
                ...
                {
                    // 卸载钩子
                    int result = Api.UnhookWindowsHookEx(this.MouseHookHandle);
                    this.MouseHookHandle = 0;
                    this.MouseDelegate = null;
                    if (result == 0)
                    {
                        int errorCode = Marshal.GetLastWin32Error();
                        throw new Win32Exception("MouseHook.Uninstall_Hook()->" + Api.GetLastErrorString(errorCode));
                    }
                }
            }
        }
        ...
        private int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            return Api.CallNextHookEx(this.MouseHookHandle, nCode, wParam, lParam);
        }
        #endregion
